...
## WORKING ON ##
################
you need to fix all the logs throughout the system making the right calls and replacing error returns in start with fails if the system is running it musn't fail.